...
We now justify this relation by applying the infinitesimal generator \(A\) to the Laplace integral.
...
\]
Integrating by parts and using the exponential decay at \(t=\infty\) together with \(T_0=\Id\), we obtain
\[
